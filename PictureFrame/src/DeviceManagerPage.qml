...
MessageDialog {
      ...
      title:  qsTr("No Picture Frame found")
      text: qsTr("Make sure your Picture Frame is turned on and in the same network. Click OK to continue.")
      buttons: MessageDialog.Ok
}

// this happens when the Picture Frame looses it's connection to the mqtt broker
MessageDialog {
      id : msgDialogConnectionFailed
      title:  qsTr("Connection failed")
      text: qsTr("Please turn on your Picture Frame. If it is already turned on, you need to restart it.")
      buttons: MessageDialog.Ok
}
...
MessageDialog {
      ...
      text: qsTr("Picture frame response did not contain Product Id. Please update your Picture Frame software")
      buttons: MessageDialog.Ok
}
...
MessageDialog {
      ...
      text: qsTr("We cannot find this Picture Frame in the local network or in the cloud")
      buttons: MessageDialog.Ok
}
...
property var devicesFromUdpBroadcast
    ...
    function __db()
    {
        return LocalStorage.openDatabaseSync("SmartCalendarDevicesModel", "1.0", "Saved Picture Frame Devices in Network", 1000000);
    }
